      SUBROUTINE NUCFFS16OT(A,Z,Q2,state,FF)
...
c       g3 = 0.0
      ...
      elseif(state.EQ.17) then   !!!   18.1 MeV
        g1 = 1.9E-4*exp(-1.0*(qf-0.8)**2/0.35/0.35)
        g2 = 1.8E-4*exp(-1.0*(qf-1.25)**2/0.45/0.45)        
...
c       g3 = 0.0
      ...
      elseif(state.EQ.18) then   !!!   19.3 MeV
        g1 = 10.2E-4*exp(-1.0*(qf-1.32)**2/0.77/0.77)
        g2 = 3.75E-4*exp(-1.0*(qf-1.7)**2/0.6/0.6)
...
c       g3 = 0.0
      ...
      elseif(state.EQ.19) then   !!!   20.6 MeV
        g1 = 1.9E-4*exp(-1.0*(qf-1.45)**2/0.5/0.5)
