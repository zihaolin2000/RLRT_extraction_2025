...
CCCCC   Modified on 5/7/25 to include quasideuterons at low Q^2   CCCCC      
      IMPLICIT none

      real*8 e,ep,th,q2,q2t,w2,x,cs,flux,kappa2,sin2,tan2,csmod
      real*8 f1,f2,fl,f1qe,f2qe,flqe,f1mec,f2mec,fLmec,f1i,f2i,fLi
      real*8 r,rqe,sigt,sigl,sigm,f1qd,f2qd,fLqd
...
CCC  NEXT bit only needed if fitting scaling function CCC
     ...
     > (1.0+abs(psip)/psimax)**2.0/(1.0+0.08*psip**2)**1.
...
c      if(w2.GT.1.5) write(6,2000) w2,q2,f1,f1t,f2,f2t
      ...
      f1qd = 0.0
      fLqd = 0.0
      call quasideut(Z,A,w2,q2,xvalc,f1qd)
      f2qd = 2.0*x*f1qd/kappa2     


c       write(6,*) A,Z,w2,q2,f1i,f1qe,f1mec


      
      if(type.EQ.1) then     !!!  add quasideuterons
