...
CCC  Version from June 6, 2025  -  Author:  M.E. Christy                    CCC
...
CCC  replaced 2-pi threshold with eta                                       CCC
      ...
      q20 = 0.05
      q20 = xval(50)*(1.0+0.25*q20/(q20+q2))**2.0  
...
c      if(sf.EQ.2) x0(1) = 0.07   !!!  different Delta mass for sigL
...
CCC    Begin resonance Q^2 dependence calculations   CCC
     ...
     &          dip**rescoef(i,4)
          ...
          if(i.LE.6) then
             height(i) = height(i)/(1.0+0.09*q2)**2.0
          endif
        else
...
c        t1 = xval(38)*log(1.05+q2)+xval(39)/(1.05+q2)                 !!! exponent of (1-xpr)

c        write(6,*) t1
        
c        t2 = xval(40)*(1.0+q2/xval(41))**xval(43)
...
c     A0 = xval(37)/(1.0+q2/xval(39))**2.0
         A0 = xval(37)/(1.0+q2/xval(39))**2*(1.0+85.0*t)**2         
